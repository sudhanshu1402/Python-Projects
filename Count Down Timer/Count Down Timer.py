...
title_label_1 = Label(window, text="Countdown timer with notification", font=("Times New Roman", 12)).pack()
title_label_2 = Label(window, text="Put 0 in fields not of use", font=("Times New Roman", 10)).pack()
